...
public class GuestbookServiceHttp {
	...
	public static int getGuestbooksCount(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getGuestbooksCountParameterTypes5);
	...
	private static final Class<?>[] _getGuestbooksParameterTypes4 =
		new Class[] {long.class, int.class, int.class};
	private static final Class<?>[] _getGuestbooksCountParameterTypes5 =
		new Class[] {long.class};
